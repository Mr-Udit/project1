...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Udit Chauhan, founder of Digital Coding School.",
  description:
    "We are here to give you the best knowlidge of the teach world along with all the programming languages",
  resumeLinkText: "Lean More",
  resumeLink: "/about",
};
...
export const CONTACT_CONTENT = {
  ...
  email: "uditchauhan621@gmail.com",
  phone: "+919758619556",
  socialLinks: [
    {
      platform: "Twitter",
